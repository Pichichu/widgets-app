...
const cards = <Map<String,dynamic>> [
  { 'elevation' : 0.0, 'label':'Elevetion 0'},
  { 'elevation' : 1.0, 'label':'Elevetion 1'},
  { 'elevation' : 2.0, 'label':'Elevetion 2'},
  { 'elevation' : 3.0, 'label':'Elevetion 3'},
  { 'elevation' : 4.0, 'label':'Elevetion 4'},
  { 'elevation' : 5.0, 'label':'Elevetion 5'},
...
class _CartsView extends StatelessWidget {
  const _CartsView();
